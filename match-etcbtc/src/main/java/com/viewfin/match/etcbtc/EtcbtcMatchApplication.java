package com.viewfin.match.etcbtc;
...
public class EtcbtcMatchApplication implements CommandLineRunner {
    private static final Logger LOGGER = LoggerFactory.getLogger(EtcbtcMatchApplication.class);

    public static Disruptor<Order> disruptor;

    public static void main(String[] args) {
        try {
            SpringApplication application = new SpringApplication(EtcbtcMatchApplication.class);
